const info = {
    ...
    2345: {"url":"images/orange-cat.jpg", "name":"Silviu", "secret":"Secretly enjoys itchy tasty but doesn't wanna admit", "text":"Looks stiff... is stiff. Will scratch couch if disturbed from cat business.", "achievements":'This secret agent has successfully completed 882 missions and received the "The Best Stolen Secret" award and won the prize for the "Best Secret Agent of the year" twice. Very competitive spirit.<br><br>Lost to Vali this year, still believes it\'s a joke.'},
